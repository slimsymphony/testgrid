	...
	private void parseProducts(String str) {
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				try {
					line = line.trim();
					//2015-01-07 11:59:59.342 CommClient[15934:507] udid:7b15f052424a89ae5a749576eb3c91f839084b96 device_name:“Administrator”的 iPhone product_type:iPhone 6 ios_version:8.0.2 resolution:1334x750
					if(!line.isEmpty() && line.startsWith("udid")) {
						//String time = line.substring(0, line.indexOf("CommClient")).trim();
						...
						//d.setLastUpdated(CommonUtils.parseDate(time, "yyyy-MM-dd HH:mm:ss.SSS").getTime());
						loadUserDefined(d);
