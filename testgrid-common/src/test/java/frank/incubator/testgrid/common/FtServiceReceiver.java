...
public class FtServiceReceiver extends MessageListenerAdapter{
	...
	public static void main( String[] args ) throws Exception {
		...
		hub.bindHandlers( Constants.BROKER_FT, Queue.class, Constants.HUB_FILE_TRANSFER, Constants.MSG_HEAD_TARGET+"='" + Constants.MSG_TARGET_AGENT +CommonUtils.getHostName()+"'", fts, System.out );
		hub.bindHandlers( Constants.BROKER_TASK, Queue.class, Constants.HUB_TASK_COMMUNICATION, Constants.MSG_HEAD_TARGET+"='" + Constants.MSG_TARGET_AGENT +CommonUtils.getHostName()+"'", fts, System.out );
