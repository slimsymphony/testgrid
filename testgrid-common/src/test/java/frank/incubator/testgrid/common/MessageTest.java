...
public class MessageTest {
	...
	private static void amqTestQueue() throws Exception {
		...
		Date t = new Date();
		for( int i=0;i<5;i++ ) {
			mh.send( "localTcp", "testqueue", "Hello,world("+i+") @" +t.getYear()+"-"+t.getMonth()+"-"+t.getDate() +" "+ t.getHours()+":"+t.getMinutes()+":"+t.getSeconds(), new HashMap<String,Object>() {{
				...
				this.put( "object", new HashMap<String,String>(){{this.put( "aaa", "bbb" );}} );
			}} );
			mh.send( "testqueue2", "No Hello,world("+i+") @" +t.getYear()+"-"+t.getMonth()+"-"+t.getDate() +" "+ t.getHours()+":"+t.getMinutes()+":"+t.getSeconds(), new HashMap<String,Object>() {{this.put( "receiver", "bbb" );}} );
		}
		Thread.sleep( 5000 );
		mh.dispose();
	}
	...
	private static void amqTestTopic() throws Exception {
		...
		Date t = new Date();
		for( int i=0;i<5;i++ ) {
			mh.send( "testtopic", "Hello,world("+i+") @" +t.getYear()+"-"+t.getMonth()+"-"+t.getDate() +" "+ t.getHours()+":"+t.getMinutes()+":"+t.getSeconds(), new HashMap<String,Object>() {{this.put( "receiver", "aaa" );}} );
			mh.send( "testtopic", "No Hello,world("+i+") @" +t.getYear()+"-"+t.getMonth()+"-"+t.getDate() +" "+ t.getHours()+":"+t.getMinutes()+":"+t.getSeconds(), new HashMap<String,Object>() {{this.put( "receiver", "bbb" );}} );
		}
		Thread.sleep( 5000 );
		mh.dispose();
	}
