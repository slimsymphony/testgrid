...
/**
 * Plugin interface for all additional services.
 * Please always inherit from some basic AgentPlugin e.g.:{@link frank.incubator.testgrid.agent.plugin.AbstractAgentPlugin} to create a new Plugin.
 * 
 * @author Wang Frank
 * 
 */
public interface TestGridPlugin<V> extends Runnable, FutureCallback<V> {
