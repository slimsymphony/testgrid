...
public class Constants {
    ...
    /**
     * File Transfer pipe Name. which provide message communication for File transfer transaction.
     */
    ...
    /**
     * The agent check the status of device requirements of incoming task.
     * Have require devices, but device in use, need wait.
     */
    public static final int CAPABILITY_WAIT = 0;
    /**
     * The agent check the status of device requirements of incoming task.
     * Could be reserved immediately.
     */
    ...
    /**
     * Message Attribute: transaction, it means all the message during a task transaction.
     */
    ...
    /**
     * Message Attribute: whether the test is *Success*, it relevant to whether need to clean up workspace.
     */
    public static final String MSG_HEAD_TEST_SUCC = "TestSuccess";
    /**
     * Message Attribute: notification type, including: DEVICE, TASK, TEST, SYSTEM.
     */
    public static final String MSG_HEAD_NOTIFICATION_TYPE = "NotificationType";
    /**
     * Message Attribute: notification action, using along with MSG_HEAD_NOTIFICATION_TYPE.
     */
    ...
    // all the task status related message will be sent by Client side cos only client aware whole task status.
    /**
     * Task status notify number: pending (waiting for started, it means at least one or more tests in testsuite waiting for agent to be executed.);
     */
    ...
    /**
     * Task status notify number: Have been failed, means no more actions will be done for this task, at least one or more tests didn't have results.
     */
    public static final int TASK_STATUS_FAILED = -1;
    /**
     * Task status notify number: Finished, all the tests have been finished and got results.
     */
    public static final int TASK_STATUS_FINISHED = 2;
    
    // all the test status related message will be sent by Agent side cos only agent aware detail test executing status.
    /**
     * Task status notify number: pending (waiting for started, it means at least one or more tests in testsuite waiting for agent to be executed.);
     */
	...
	public static final String DEVICE_HOST_OS_TYPE = "osType";
	/*
