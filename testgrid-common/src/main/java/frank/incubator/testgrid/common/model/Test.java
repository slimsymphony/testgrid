...
public class Test extends BaseObject {
	...
	public Test() {
                //Please DO NOT change the ID prefix "Test_", since it is a convention used by other part of the system.
	 ...
	 * PENDING - Meaning that test was accepted by the Test agent, but not yet started on any of the test nodes.
	 * STARTED - Meaning that test was successfully started on the assigned test node.
	 * STOPPED - Meaning that test was stopped by some administration commands. 
	 * FINISHD - Meaning that test has ended its execution on a test node and has returned file with test result back to the test issuer. 
	...
	/**
	 * Name of the test results archive that should be generated by executor
	 ...
	 * on real phones.
	 */
	private Map<String,Long> artifacts;
