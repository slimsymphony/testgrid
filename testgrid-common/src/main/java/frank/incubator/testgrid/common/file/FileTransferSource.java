...
public interface FileTransferSource extends FileTransferResource {
	...
	/**
	 * Publish Files to be transferred with token. And waiting for incoming
	 * request for these files. Refer to FileTransferMode.SOURCE_HOST mode.
	...
	/**
	 * Push Files to target actively. Refer to FileTransferMode.TARGET_HOST
	 * mode. Which means the server was located on Target side(test agent);
	 * 
	 * @param token
	 * @param fileList
	 * @throws Exception
