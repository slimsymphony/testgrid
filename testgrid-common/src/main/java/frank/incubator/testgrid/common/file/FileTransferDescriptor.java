...
/**
 * Descriptor for all the FileTransfer Channels. Represent a FT end-point host
 * information. Also was used be communicate with other FT end-point. The
 * channels collection will always keep order by priority.
 * 
 * @author Wang Frank
 * 
 */
